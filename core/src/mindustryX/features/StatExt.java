...
public class StatExt{
    ...
    dragMultiplier = new Stat("dragMultiplier"),//移动阻力倍率

    bufferCapacity = new Stat("bufferCapacity", StatCat.items),
    sepOutput = new Stat("sepOutput", StatCat.crafting),
    regenSpeed = new Stat("regenSpeed", StatCat.function),//力墙 回复速度
    regenSpeedBroken = new Stat("regenSpeedBroken", StatCat.function),//力墙 过热时回复速度
    mend = new Stat("mend", StatCat.function),//治疗 修复量
    mendReload = new Stat("mendReload", StatCat.function),//治疗 修复间隔
    mendSpeed = new Stat("mendSpeed", StatCat.function),//治疗 修复速度
    warmupPartial = new Stat("warmupPartial", StatCat.power),//冲击 启动时间
    warmupTime = new Stat("warmupTime", StatCat.power),//冲击 完全启动时间
    warmupPower = new Stat("warmupPower", StatCat.power),//冲击 启动总耗电
    ...
    crushDamage = new Stat("crushDamage", StatCat.combat),//碾压伤害(每格)

...
public class MobileScriptButtons extends ScriptButtons{
    ...
    protected void setup(){
        ...
        scriptButton(Blocks.radar.uiIcon, "雷达扫描", () -> {

...
public class MusicDialog extends BaseDialog{
    ...
    public static class LRC extends LYRIC{
        final Seq<Double> timeList;
        final Seq<String> lrcList;
        int size, cached;
        double last;
    ...
    private class NetEaseMusic extends NetApi{
        final NetEastEncryptor encryptor = new NetEastEncryptor();
    ...
    static class NetEastEncryptor{
        final IvParameterSpec iv = new IvParameterSpec(new byte[]{48, 49, 48, 50, 48, 51, 48, 52, 48, 53, 48, 54, 48, 55, 48, 56});
        final BigInteger modulus = new BigInteger("1577947502671315022124768178003454981218727833333897474240115310"
        ...
        final BigInteger pk = new BigInteger("65537");
